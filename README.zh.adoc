...
*** https://github.com/YanWenKun/ComfyUI-WinPortable-XPU/releases/download/r1-arl/ComfyUI_Windows_portable_arl.7z.001[ComfyUI_Windows_portable_arl.7z.001]

*** https://github.com/YanWenKun/ComfyUI-WinPortable-XPU/releases/download/r1-arl/models.zip.001[models.zip.001] （模型包，只需下载一次，以后升级无需重复下载）

** **其他所有型号**用户：

*** https://github.com/YanWenKun/ComfyUI-WinPortable-XPU/releases/download/r1-xpu/ComfyUI_Windows_portable_xpu.7z.001[ComfyUI_Windows_portable_xpu.7z.001]

*** https://github.com/YanWenKun/ComfyUI-WinPortable-XPU/releases/download/r1-xpu/models.zip.001[models.zip.001] （模型包，只需下载一次，以后升级无需重复下载）

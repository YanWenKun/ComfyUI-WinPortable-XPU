...
** https://github.com/YanWenKun/ComfyUI-WinPortable-XPU/releases/latest/download/models.zip.001[models.zip.001] (Model package, only needs to be downloaded once, no need to re-download for future updates)

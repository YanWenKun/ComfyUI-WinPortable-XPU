...
*** https://github.com/YanWenKun/ComfyUI-WinPortable-XPU/releases/download/r1-arl/models.zip.001[models.zip.001] (Model package, only needs to be downloaded once, no need to re-download for future updates)
...
*** https://github.com/YanWenKun/ComfyUI-WinPortable-XPU/releases/download/r1-xpu/models.zip.001[models.zip.001] (Model package, only needs to be downloaded once, no need to re-download for future updates)

...
curl -sSL \
https://github.com/astral-sh/python-build-standalone/releases/download/20260320/cpython-3.12.13+20260320-x86_64-pc-windows-msvc-install_only.tar.gz \
    -o python.tar.gz
...
# Add FFmpeg binary
curl -sSL https://github.com/GyanD/codexffmpeg/releases/download/8.1/ffmpeg-8.1-full_build.zip \
    -o ffmpeg.zip
